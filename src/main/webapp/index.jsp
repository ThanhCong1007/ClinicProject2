...
<head>
    ...
    <link href="<%=request.getContextPath() %>/libra/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
    <link href="<%=request.getContextPath() %>/libra/animate/animate.min.css" rel="stylesheet">
    <link href="<%=request.getContextPath() %>/libra/tempusdominus/css/tempusdominus-bootstrap-4.min.css" rel="stylesheet" />
...
<body>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">Phòng khám Công Cường cung cấp dịch vụ chăm sóc răng miệng tốt nhất</h1>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown">Hãy giữ cho răng của bạn được khỏe mạnh</h5>
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">Kết nối với phòng khám để có trải nghiệm chất lượng nhất</h1>
                            <a href="<%=request.getContextPath() %>/templates/appointment.jsp" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Đặt hẹn</a>
                            <a href="" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Liên hệ</a>
                        </div>
                    </div>
            ...
            <div class="row gx-0">
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.1s">
                    <div class="bg-primary d-flex flex-column p-5" style="height: 300px;">
                        <h3 class="text-white mb-3">Các khung giờ khám</h3>
                ...
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.3s">
                    <div class="bg-dark d-flex flex-column p-5" style="height: 300px;">
                        <h3 class="text-white mb-3">Chọn dịch vụ khám</h3>
                        ...
                        <a class="btn btn-light" href="">Xác nhận</a>
                    </div>
                </div>
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.6s">
                    <div class="bg-secondary d-flex flex-column p-5" style="height: 300px;">
                        <h3 class="text-white mb-3">Kết nối để nhận tư vấn</h3>
                        <p class="text-white">Đăt lịch khám với khung giờ linh hoạt, lựa chọn bác sĩ giàu kinh nghiệm
                        					phù hợp với nhu cầu của bạn</p>
                        <h2 class="text-white mb-0">0842326539</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-7">
                    ...
                    <a href="<%=request.getContextPath() %>/templates/appointment.jsp" class="btn btn-primary py-3 px-5 mt-4 wow zoomIn" data-wow-delay="0.6s">Đặt lịch khám ngay</a>
                </div>
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s" src="<%=request.getContextPath() %>/images/about.jpg" style="object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row gx-5">
                <div class="col-lg-6 py-5">
                    <div class="py-5">
                        <h1 class="display-5 text-white mb-4">Nha sĩ với nhiều năm kinh nghiệm và chứng nhận quốc tế</h1>
                        <p class="text-white mb-0">Eirmod sed tempor lorem ut dolores. Aliquyam sit sadipscing kasd ipsum. Dolor ea et dolore et at sea ea at dolor, justo ipsum duo rebum sea invidunt voluptua. Eos vero eos vero ea et dolore eirmod et. Dolores diam duo invidunt lorem. Elitr ut dolores magna sit. Sea dolore sanctus sed et. Takimata takimata sanctus sed.</p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="appointment-form h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
                        <h1 class="text-white mb-4">Cung cấp thông tin để nhận tư vấn</h1>
                        <form>
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-dark w-100 py-3" type="submit">Nhận tư vấn</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="row g-5 mb-5">
                <div class="col-lg-5 wow zoomIn" data-wow-delay="0.3s" style="min-height: 400px;">
                    <div class="twentytwenty-container position-relative h-100 rounded overflow-hidden">
                        <img class="position-absolute w-100 h-100" src="<%=request.getContextPath() %>/images/before.jpg" style="object-fit: cover;">
                        <img class="position-absolute w-100 h-100" src="<%=request.getContextPath() %>/images/after.jpg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="section-title mb-5">
                        <h5 class="position-relative d-inline-block text-primary text-uppercase">Các dịch vụ</h5>
                        <h1 class="display-5 mb-0">Thiết bị hiện đại, chất lượng dịch vụ luôn hài lòng khách hàng</h1>
                    </div>
                    <div class="row g-5">
            ...
            <div class="row g-5 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="col-lg-5 service-item wow zoomIn" data-wow-delay="0.9s">
                    <div class="position-relative bg-primary rounded h-100 d-flex flex-column align-items-center justify-content-center text-center p-4">
                        <h1 class="display-5 text-white mb-3">Ưu đãi lên đến 30%</h1>
                        ...
                        <a href="<%=request.getContextPath() %>/templates/appointment.jsp" class="btn btn-dark py-3 px-5 me-3">Nhận ưu đãi ngay</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-5">
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.1s">
                    <div class="section-title bg-light rounded h-100 p-5">
                        ...
                        <h1 class="display-6 mb-4">Gặp gỡ các nha sĩ giàu kinh nghiệm</h1>
                        <a href="<%=request.getContextPath() %>/templates/appointment.jsp" class="btn btn-primary py-3 px-5">Đặt lịch khám</a>
                    </div>
                </div>
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <div class="position-relative rounded-top" style="z-index: 1;">
                            <img class="img-fluid rounded-top w-100" src="<%=request.getContextPath() %>/images/team-1.jpg" alt="">
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                    <div class="team-item">
                        <div class="position-relative rounded-top" style="z-index: 1;">
                            <img class="img-fluid rounded-top w-100" src="<%=request.getContextPath() %>/images/team-2.jpg" alt="">
                            <div class="position-absolute top-100 start-50 translate-middle bg-light rounded p-2 d-flex">
                                <a class="btn btn-primary btn-square m-1" href="#"><i class="fab fa-twitter fw-normal"></i></a>
                                <a class="btn btn-primary btn-square m-1" href="#"><i class="fab fa-facebook-f fw-normal"></i></a>
                                <a class="btn btn-primary btn-square m-1" href="#"><i class="fab fa-linkedin-in fw-normal"></i></a>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <div class="position-relative rounded-top" style="z-index: 1;">
                            <img class="img-fluid rounded-top w-100" src="<%=request.getContextPath() %>/images/team-3.jpg" alt="">
                            <div class="position-absolute top-100 start-50 translate-middle bg-light rounded p-2 d-flex">
                                <a class="btn btn-primary btn-square m-1" href="#"><i class="fab fa-twitter fw-normal"></i></a>
                                <a class="btn btn-primary btn-square m-1" href="#"><i class="fab fa-facebook-f fw-normal"></i></a>
                                <a class="btn btn-primary btn-square m-1" href="#"><i class="fab fa-linkedin-in fw-normal"></i></a>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <div class="position-relative rounded-top" style="z-index: 1;">
                            <img class="img-fluid rounded-top w-100" src="<%=request.getContextPath() %>/images/team-4.jpg" alt="">
                            <div class="position-absolute top-100 start-50 translate-middle bg-light rounded p-2 d-flex">
                                <a class="btn btn-primary btn-square m-1" href="#"><i class="fab fa-twitter fw-normal"></i></a>
                                <a class="btn btn-primary btn-square m-1" href="#"><i class="fab fa-facebook-f fw-normal"></i></a>
                                <a class="btn btn-primary btn-square m-1" href="#"><i class="fab fa-linkedin-in fw-normal"></i></a>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                    <div class="team-item">
                        <div class="position-relative rounded-top" style="z-index: 1;">
                            <img class="img-fluid rounded-top w-100" src="<%=request.getContextPath() %>/images/team-5.jpg" alt="">
                            <div class="position-absolute top-100 start-50 translate-middle bg-light rounded p-2 d-flex">
                                <a class="btn btn-primary btn-square m-1" href="#"><i class="fab fa-twitter fw-normal"></i></a>
                                <a class="btn btn-primary btn-square m-1" href="#"><i class="fab fa-facebook-f fw-normal"></i></a>
                                <a class="btn btn-primary btn-square m-1" href="#"><i class="fab fa-linkedin-in fw-normal"></i></a>
    ...
    <script src="<%=request.getContextPath() %>/libra/wow/wow.min.js"></script>
    <script src="<%=request.getContextPath() %>/libra/easing/easing.min.js"></script>
    <script src="<%=request.getContextPath() %>/libra/waypoints/waypoints.min.js"></script>
    <script src="<%=request.getContextPath() %>/libra/owlcarousel/owl.carousel.min.js"></script>
    <script src="<%=request.getContextPath() %>/libra/tempusdominus/js/moment.min.js"></script>
    <script src="<%=request.getContextPath() %>/libra/tempusdominus/js/moment-timezone.min.js"></script>
    <script src="<%=request.getContextPath() %>/libra/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>
    <script src="<%=request.getContextPath() %>/libra/twentytwenty/jquery.event.move.js"></script>
    <script src="<%=request.getContextPath() %>/libra/twentytwenty/jquery.twentytwenty.js"></script>
